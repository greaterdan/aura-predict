 ...
 */
export function calculateAgentStats(agentId, trades) {
 ...
 */
export function calculateAllAgentStats(tradesByAgent) {
    const stats = [];
    for (const [agentId, trades] of Object.entries(tradesByAgent)) {
        stats.push(calculateAgentStats(agentId, trades));
    }
