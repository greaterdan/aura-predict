 ...
 */
const ongoingGeneration = new Map();
/**
 ...
 */
export async function generateAgentTrades(agentId) {
    ...
    const generationPromise = (async () => {
        try {
            ...
            const researchedMarketIds = new Set();
 ...
 */
export function getAgentResearch(agentId) {
